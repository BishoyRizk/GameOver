...
form.addEventListener('input',function(){
    if(valadationName(inputs[0]) && valadationName(inputs[1])&& valadationEmail()&& valadationPassword()&& valadationage()){
...
inputs[0].addEventListener('input',function(){
    valadationName(inputs[0])
    
})

inputs[1].addEventListener('input',function(){
    valadationName(inputs[1])
...
function valadationEmail(){
    ...
    if(regexforemail.test(inputs[2].value)){
...
function valadationPassword(){
    ...
    if(regexforpassword.test(inputs[3].value)){
